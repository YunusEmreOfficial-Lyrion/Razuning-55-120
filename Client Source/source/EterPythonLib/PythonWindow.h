	...
	class CWindow
	{
		public:
			...
			enum EFlags
			{
				...
				FLAG_ALPHA_SENSITIVE	 = ( 1 << 12 ), // alfa duyarlılı?ını etkinle?tirmek icin i?aret
			};
		...
		public:
			...
			enum WindowTypes // geni?letilmi?_image sınıfını tanımak icin pencere tipi bayrakları
			{
				WINDOW_TYPE_WINDOW,
