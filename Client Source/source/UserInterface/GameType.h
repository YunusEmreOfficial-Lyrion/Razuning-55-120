...
#else
	const DWORD c_New_Equipment_Start = c_Equipment_Start + 21 + 1 + 1;
#endif
...
enum EDragonSoulStepTypes
{
	...
	const DWORD c_Costume_Slot_Sebnem_Sarý		= c_Costume_Slot_Start + CItemData::COSTUME_SEBNEM_SARI;
	...
	const DWORD c_Costume_Slot_Karanlýk = c_Costume_Slot_Start + CItemData::COSTUME_TILSIM_KARANLIK;
#endif
