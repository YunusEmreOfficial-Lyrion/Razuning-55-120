...
#ifdef RING_SYSTEM
	PyModule_AddIntConstant(poModule, "RING_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "RING_SYSTEM",	0);
#endif

#ifdef DEW_SYSTEM
	PyModule_AddIntConstant(poModule, "DEW_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "DEW_SYSTEM",	0);
#endif

#ifdef TALISMAN_SYSTEM
	PyModule_AddIntConstant(poModule, "TALISMAN_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "TALISMAN_SYSTEM",	0);
#endif

#ifdef METIN_BOSS_HUNTER
	PyModule_AddIntConstant(poModule, "METIN_BOSS_HUNTER",	1);
#else
	PyModule_AddIntConstant(poModule, "METIN_BOSS_HUNTER",	0);
#endif
...
PyModule_AddIntConstant(poModule, "WJ_NEW_DROP_DIALOG", 0);
	...
	PyModule_AddIntConstant(poModule, "__BL_GRAPHIC_ON_OFF__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_GRAPHIC_ON_OFF__", false);
#endif

#ifdef STONE_SCALE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_STONE_SCALE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_STONE_SCALE", 0);
#endif
