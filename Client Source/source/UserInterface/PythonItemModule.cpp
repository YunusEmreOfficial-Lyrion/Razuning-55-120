...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_SEBNEM_SARI",			c_Costume_Slot_Sebnem_Sarý);
	...
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_KARANLIK",			c_Costume_Slot_Karanlýk);
#endif
