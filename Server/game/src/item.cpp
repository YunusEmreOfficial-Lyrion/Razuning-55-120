...
#endif
#ifdef DEW_SYSTEM
		else if (GetSubType() == COSTUME_SEBNEM_KIRMIZI)
			return WEAR_COSTUME_SEBNEM_KIRMIZI;
		else if (GetSubType() == COSTUME_SEBNEM_TURUNCU)
			return WEAR_COSTUME_SEBNEM_TURUNCU;
		else if (GetSubType() == COSTUME_SEBNEM_SARI)
			return WEAR_COSTUME_SEBNEM_SARI;
		else if (GetSubType() == COSTUME_SEBNEM_YESIL)
			return WEAR_COSTUME_SEBNEM_YESIL;
		else if (GetSubType() == COSTUME_SEBNEM_MAVI)
			return WEAR_COSTUME_SEBNEM_MAVI;
		else if (GetSubType() == COSTUME_SEBNEM_BEYAZ)
			return WEAR_COSTUME_SEBNEM_BEYAZ;
#endif
#ifdef TALISMAN_SYSTEM
		else if (GetSubType() == COSTUME_TILSIM_ATES)
			return WEAR_COSTUME_TILSIM_ATES;
		else if (GetSubType() == COSTUME_TILSIM_TOPRAK)
			return WEAR_COSTUME_TILSIM_TOPRAK;
		else if (GetSubType() == COSTUME_TILSIM_RUZGAR)
			return WEAR_COSTUME_TILSIM_RUZGAR;
		else if (GetSubType() == COSTUME_TILSIM_SIMSEK)
			return WEAR_COSTUME_TILSIM_SIMSEK;
		else if (GetSubType() == COSTUME_TILSIM_BUZ)
			return WEAR_COSTUME_TILSIM_BUZ;
		else if (GetSubType() == COSTUME_TILSIM_KARANLIK)
			return WEAR_COSTUME_TILSIM_KARANLIK;
#endif
#ifdef METIN_BOSS_HUNTER
		else if (GetSubType() == COSTUME_HUNTER_METIN)
			return WEAR_COSTUME_HUNTER_METIN;
		else if (GetSubType() == COSTUME_HUNTER_BOSS)
			return WEAR_COSTUME_HUNTER_BOSS;
#endif
	}
