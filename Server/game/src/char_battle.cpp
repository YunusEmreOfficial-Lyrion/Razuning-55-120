...
DWORD CHARACTER::GetHunterLevelInfo(BYTE Hunter_Level)
{
	DWORD HUNTER_LEVEL_LIMIT_INFO = 0;
	switch (Hunter_Level)
	{
		case 1:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT_1;
			}
			break;
		case 2:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT_2;
			}
			break;
		case 3:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT_3;
			}
			break;
		case 4:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT_4;
			}
			break;
		case 5:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT_5;
			}
			break;
		case 6:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT_6;
			}
			break;
		case 7:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT_7;
			}
			break;
		default:
			{
				HUNTER_LEVEL_LIMIT_INFO = EHunterLevelLimit::HUNTER_LEVEL_LIMIT;
			}
			break;
	}
	
	return HUNTER_LEVEL_LIMIT_INFO;
}
DWORD CHARACTER::GetHunterLevelBonusInfo(BYTE Hunter_Level)
{
	DWORD HUNTER_LEVEL_BONUS_INFO = 0;
	switch (Hunter_Level)
	{
		case 1:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS_1;
			}
			break;
		case 2:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS_2;
			}
			break;
		case 3:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS_3;
			}
			break;
		case 4:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS_4;
			}
			break;
		case 5:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS_5;
			}
			break;
		case 6:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS_6;
			}
			break;
		case 7:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS_7;
			}
			break;
		default:
			{
				HUNTER_LEVEL_BONUS_INFO = EHunterLevelLimit::HUNTER_LEVEL_BONUS;
			}
			break;
	}
	
	return HUNTER_LEVEL_BONUS_INFO;
}
#endif
